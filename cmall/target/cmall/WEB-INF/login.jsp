...
<body>
<div class=header-simple> <div class=w> <a href=./index.html class=logo>MMall</a> </div> </div>
<div class="user-wrap">
    <div class="user-con w">
        ...
        <div class="user-box">
            ...
            <div class="link-item">
                ...
                <a class="link register" href="./register.html" target="_blank">免费注册</a>
            </div>
        </div>
    </div>
</div>
<div class=footer> <div class=w>
    <div class=links>
        <a class=link href=http://www.imooc.com/ >慕课网</a>
    ...
    <p class=copyright> Copyright © 2017 happymmall.com All Rights Reserved </p>
</div>
</div>
</body>
</html>
