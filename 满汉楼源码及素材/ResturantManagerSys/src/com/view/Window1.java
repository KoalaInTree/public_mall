...
public class Window1 extends JFrame implements ActionListener, MouseListener {
	...
	JPanel jbottom;
	JPanel jp3_rs,jp3_login,jp3_dishes,jp3_chart,jp3_cost,jp3_sysrest,jp3_help; //各个主页面
	...
	JButton jb1,jb2,jb3,jb4,jb5,jb6,jb7,jb8,jb9,jb10; //定义工具栏按钮
	JSplitPane jsp1;
	...
	public void initToolBar()
	{
		...
		jb8.setToolTipText("系统设置");
		jb9.setToolTipText("动画帮助");
		jb10.setToolTipText("系统信息");
	...
	public void initMainPane()
	{
		...
		jp1_lab7=new JLabel("系 统 设 置", new ImageIcon("images/label_7.png"), 0);
		jp1_lab8=new JLabel("动 画 帮 助", new ImageIcon("images/label_8.png"), 0);
