...
public class OrderIndex extends JFrame implements MouseListener,ActionListener {
	...
	JToolBar jtb;
	JButton jb1,jb2,jb3,jb4,jb5; //工具栏按钮
...
//	}
	...
	public void initToolBar()
	{
		...
		jb4 = new JButton(new ImageIcon("images/jb5.png"));
		jb5 = new JButton(new ImageIcon("images/jb10.png"));
		
		jb1.setToolTipText("切换到管理界面");
		jb2.setToolTipText("切换用户");
		jb3.setToolTipText("请求帮助");
		jb4.setToolTipText("报表统计");
		jb5.setToolTipText("帮助");
	...
	public void initSplitPane()
	{
		//获取背景图
		try {
			jp_left_bgImg = ImageIO.read(new File("images/orderIndex.png"));
		...
		jp_right_bg.setLayout(new GridLayout(9,1));
		...
		//处理左边面板
		jp_disk = new JPanel(new GridLayout(9,1));
